...
$(function() {
    ...
    if ($('#amchart-stock-1').length > 0) {
    	...
    	var chart = AmCharts.makeChart( "amchart-stock-1", {
    		"type": "stock",
    		"theme": "light",
    		"dataSets": [ {
    			"title": "USD",
    ...
    if ($('#amchart-stock-2').length > 0) {
    	...
    	var chart = AmCharts.makeChart( "amchart-stock-2", {
    		"type": "stock",
    		"theme": "light",
    		"dataSets": [ {
    			"color": "#b0de09",
    ...
    if ($('#amchart-stock-3').length > 0) {
    	...
    	var chart = AmCharts.makeChart( "amchart-stock-3", {
    		"type": "stock",
    		"theme": "light",
    		"dataSets": [ {
    			"color": "#b0de09",
    ...
    if ($('#amchart-stock-4').length > 0) {
    	...
    	var chart = AmCharts.makeChart( "amchart-stock-4", {
    		"type": "stock",
    		"theme": "light",
    		"dataSets": [ {
    			"fieldMappings": [ {
